...
test_that(".update_fenced_block unit test", {
  ...
  testthat::expect(rlang::caller_env(n = 2)$ok,
    ...
    srcref = srcref(srcfile("../../R/import-standalone-codegen.R"), c(79, 1, 79+1, 1))
  )
})
...
test_that(".delete_fenced_block unit test", {
  ...
  testthat::expect(rlang::caller_env(n = 2)$ok,
    failure_message = "Source link for failing @unit test.",
    srcref = srcref(srcfile("../../R/import-standalone-codegen.R"), c(233, 1, 233+1, 1))
  )
})
...
test_that(".glue_recover_pieces unit test", {
  ...
  testthat::expect(rlang::caller_env(n = 2)$ok,
    failure_message = "Source link for failing @unit test.",
    srcref = srcref(srcfile("../../R/import-standalone-codegen.R"), c(346, 1, 346+1, 1))
  )
})
...
test_that(".glue_detect_output unit test", {
  ...
  testthat::expect(rlang::caller_env(n = 2)$ok,
    failure_message = "Source link for failing @unit test.",
    srcref = srcref(srcfile("../../R/import-standalone-codegen.R"), c(380, 1, 380+1, 1))
  )
})
